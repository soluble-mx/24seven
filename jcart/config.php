...
$config['paypal']['id']           = 'angel.sg@lentes24seven.com';
...
$config['text']['checkoutPaypal'] = 'Pagar con PayPal';    // Checkout with PayPal
$config['text']['removeLink']     = '';    // remove
$config['text']['emptyButton']    = '';    // empty
$config['text']['emptyMessage']   = 'TU CARRITO ESTA VACÍO';    // Your cart is empty!
